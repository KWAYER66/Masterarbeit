...
def train_model(Z,Y,weights):
	...
	input_layer3 = Input(shape= (X3.shape[1]),name='zuordnung')
	...
	dense3_1 = Dense((51*2), activation="relu")(input_layer3)
	dense3_2 = Dense((51*3), activation="relu")(dense3_1)
	flat2 = Flatten()(dense3_2)
	...
	model = Model(inputs = [input_layer,input_layer3], outputs = outputs1, name = 'functional_model2')
