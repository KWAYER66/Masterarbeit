...
def train_model(Z,K,weights):
	...
	#LSTM_1_1 = LSTM((176),return_sequences=True, activation="relu", input_shape=(None,1,6804), kernel_initializer=initializer)(input_layer)
	...
	#LSTM_1_2 =LSTM((3402),return_sequences=True, activation="relu", input_shape=(None,1,6804), kernel_initializer=initializer)(input_layer)
	dense1_2 = Dense((704),activation="relu")(Dropout_1_1)
	dense1_3 = Dense((352),activation="relu")(dense1_2)
