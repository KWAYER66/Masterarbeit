...
kl_div = open('D:\Masterarbeit\Predictions\prediction002_176_1_1_4_500\kl_divergencen2.tsv')
kl_divZ = kl_div.readlines()
if os.path.exists('D:\Masterarbeit\DBDsKL_DIV') == False:
    os.makedirs('D:\Masterarbeit\DBDsKL_DIV')

for folder in dbd:
    if 'ergebnis' not in folder:
        dbdkl_div_datei = open('D:\Masterarbeit\DBDsKL_DIV\\'+folder+'.tsv', 'w')
