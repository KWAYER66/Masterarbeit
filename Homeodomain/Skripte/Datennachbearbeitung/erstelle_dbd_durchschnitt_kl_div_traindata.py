...
durchschnitt_dbd = open('D:\Masterarbeit\DBDsmedianKL_DIVtrain.tsv', 'w')
dbdkl_div = os.listdir('D:\Masterarbeit\DBDsKL_DIVtrain')

for datei in dbdkl_div:
    durchschnitt_dbd.write(datei.split('.')[0]+'.'+datei.split('.')[1]+'\t')
    oeffnekl_div = open('D:\Masterarbeit\DBDsKL_DIVtrain\\'+datei)
