...
def test():
    ...
    predictions = os.listdir('D:\Masterarbeit\Predictions_Beste2_Mit_Bildern')
    for prediction in predictions:
        if 'prediction' in prediction:
            ausgaberepresentanten = open('D:\Masterarbeit\Predictions_Beste2_Mit_Bildern\\'+prediction+'\kl_divergencenrepresentanten.tsv','w')
            ausgabeandere = open('D:\Masterarbeit\Predictions_Beste2_Mit_Bildern\\'+prediction+'\kl_divergencenandere.tsv','w')
            kl_div = open('D:\Masterarbeit\Predictions_Beste2_Mit_Bildern\\'+prediction+'\kl_divergencen2.tsv')
