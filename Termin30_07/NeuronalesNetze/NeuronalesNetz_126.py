...
def train_model(Z,Y,weights):
	...
	dense1_4 = Dense((1200),activation="relu")(dense1_3)
	dense1_5 = Dense((600),activation="relu")(dense1_4)
	dense1_6 = Dense((455),activation="relu")(dense1_5)
	dense1_7 = Dense((280),activation="relu")(dense1_6)
	flat1 = Flatten()(dense1_7)
	initializer = tf.keras.initializers.GlorotUniform()
	dense2_1 = LSTM((1000), activation="relu", input_shape=(None,1,1618), kernel_initializer=initializer)(input_layer2)
	Dropout2_1 = Dropout(0.25)(dense2_1)
	dense2_2 = Dense((500), activation="relu")(Dropout2_1)
	flat2 = Flatten()(dense2_2)
	...
	model = Model(inputs = [input_layer,input_layer2], outputs = outputs1, name = 'functional_model2')
