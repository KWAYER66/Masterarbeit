...
def train_model(X,Y):
	...
	#Conv1_1 = Conv1D(filters = 2, kernel_size=1188,strides = 1188,activation="relu")(input_layer)
	#flatten1 = Flatten()(input_layer)
	dense1_1 = Dense((2500),activation="relu")(input_layer)
