...
def train_model(X,Y):
	...
	Conv1_1 = Conv1D(filters = 8, kernel_size = 1, strides = 1,activation="relu", input_shape=[X.shape[1],X.shape[2]])(input_layer)
	Conv1_2 = Conv1D(filters = 16, kernel_size = 3, strides = 1, activation = "relu")(Conv1_1)
